...
public class UserController {
    ...
    public BaseResponse<Page<User>> recommendUsers(long pageSize, long pageNum, HttpServletRequest request) {
        ...
        Page<User> userPage = userService.getRecommendUsers(loginUser.getId(), pageNum, pageSize);
    ...
    public BaseResponse<List<String>> getUserTags(HttpServletRequest request) {
        User loginUser = userService.getLoginUser(request);
        List<String> tags = userService.getUserTags(loginUser.getId());
    ...
    public BaseResponse<Boolean> updateUserTags(@RequestBody List<String> tagNames, HttpServletRequest request) {
        if (tagNames == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        User loginUser = userService.getLoginUser(request);
        boolean result = userService.updateUserTags(loginUser.getId(), tagNames, loginUser);
        return ResultUtils.success(result);
    }
